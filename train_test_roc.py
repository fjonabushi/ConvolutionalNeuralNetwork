...
# USAGE
# python trainn_test_roc.py --dataset1 dataset_old/cells/Q6 --dataset2 dataset_old/cells/Q6_new1 --model1 output/lenet_new6.1.1.hdf5 --model2 output/lenet_new6.1.1.hdf5
...
workbook2 = xlsxwriter.Workbook('output_xls/Q_new6_5l.xlsx')
